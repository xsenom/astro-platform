    ...
    <main className="landingMiniShell">
          ...
          <aside className="landingMiniInfoCard">
            ...
            <div className="landingMiniInfoBlock" id="contacts">
              ...
              <div className="landingMiniInfoActions">
                <Link className="btn btnPrimary" href="/cabinet">
                  Войти в кабинет
                  <ArrowRight size={16} />
                </Link>
      ...
      <section className="landingDetailRow" id="consulting">
        <article className="landingDetailCard">
          ...
          <h2>Лендинг доступен на отдельном маршруте `/main`, а кнопка личного кабинета сразу открывает раздел cabinet.</h2>
          <p>
            Такой сценарий разделяет презентацию сервиса и авторизацию: Человек открывает отдельный лендинг, знакомится с сервисом и по кнопке сразу переходит в cabinet без дополнительного промежуточного экрана.
          </p>
        </article>
      </section>
    </main>
